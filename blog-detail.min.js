...
function getBlogDetails(singleBlogDetails){
    ...
    var blogSummer = document.createElement("div");
    blogSummer.className = "blog-summary";
    blogSummer.innerHTML += singleBlogDetails.postSummary;
    detailContainer.appendChild(blogSummer);
