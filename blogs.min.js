...
function latestBlog(singleBlog){
     ...
     if(incomingImgSource){
        ...
        singleBlogImage = "https://prod-simpo.s3.ap-south-1.amazonaws.com/prod-images/323007c1718458240662plus%20new%20logo.png";
     }
...
function oldBlogs(){
    ...
    for (var i = 0; i < responseData.length; i++) {
        ...
        if(blogImageSource){
            ...
            imageSource.src = "https://storage.googleapis.com/getplus.in/images/whitelogo.png";
        }
