...
let baseUrl = 'https://api.simpo.ai/business/blog/business';
let responseData = [];
...
function latestBlog(singleBlog){
     ...
     if(incomingImgSource){
        ...
        singleBlogImage = "https://prod-simpo.s3.ap-south-1.amazonaws.com/prod-images/202957c1718458705977plus%20new%20logo.png";
     }
...
function oldBlogs(){
    ...
    for (var i = 0; i < responseData.length; i++) {
        ...
        imageSource.loading = "lazy";
        let blogImageSource = blog.blocks.find(x => x.type === 'image');
        if(blogImageSource){
            imageSource.src = blogImageSource.data.file.url;
        }
        else{
            imageSource.className = "default-image";
            imageSource.src = "https://prod-simpo.s3.ap-south-1.amazonaws.com/prod-images/202957c1718458705977plus%20new%20logo.png";
        }
...
function readMore(){
    ...
    console.log(window.parent.location.href,window.top.location.href ,parent.document.location.href)
}
